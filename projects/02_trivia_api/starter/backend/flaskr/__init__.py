...
@app.route(‘/question/search’, meathods = [‘POST’]
...
Formatted_result =  [q.format() for q in questions]
...
@app. Route ( ‘/question/category-id> ' , methods = [ 'GET'])
def get_questions (category_id)
	result = Question.query.Filter(Question.category = category-id)
	Formatted_result =  [q.format() for q in questions]
